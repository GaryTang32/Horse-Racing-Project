...
if __name__ == "__main__":
	...
	df_records_jockey = df_records.join(df_jockey,"Jockey_ID",'left')
	...
	df_records_jockey_trainer_race_horse_sectional = df_records_jockey_trainer_race_horse.join(df_sectional,["Horse_ID","Race_ID"],'left')
